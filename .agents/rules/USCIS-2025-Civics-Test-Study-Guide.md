...
```mermaid
graph TD
    USG[U.S. Government] --> LB[Legislative Branch<br/>Congress]
    USG --> EB[Executive Branch<br/>President]
    USG --> JB[Judicial Branch<br/>Supreme Court]
```
...
```mermaid
graph TD
    USC[U.S. Congress] --> HR[U.S. House of<br/>Representatives]
    USC --> SEN[U.S. Senate]
```
...
```mermaid
graph TD
    Const("Constitution<br/>(provided a separation of powers)") --> Leg["Legislative Branch<br/>(makes federal laws)"]
    Const --> Exec["Executive Branch<br/>(enforces federal laws)"]
    Const --> Jud["Judicial Branch<br/>(reviews federal laws)"]

    Leg --- Congress[Congress]
    Congress --- Senate[Senate]
    Congress --- House[House of Representatives]

    Exec --- President[President]
    Exec --- VP[Vice President]
    Exec --- Cabinet[Cabinet]

    Jud --- SC[Supreme Court]
    Jud --- OFC[Other Federal Courts]
```
...
graph TD
    ...
    LB --> USC[U.S. Congress]
    USC --> HR[U.S. House of<br/>Representatives]
    USC --> SEN[U.S. Senate]
    
    style LB fill:#b0c4de,stroke:#333,stroke-width:1px
    style HR fill:#4682b4,stroke:#333,stroke-width:1px,color:#fff
    style SEN fill:#4682b4,stroke:#333,stroke-width:1px,color:#fff
    style USC fill:#003366,stroke:#333,stroke-width:1px,color:#fff
```
...
```mermaid
graph TD
    Congress(U.S. Congress) --> House[U.S. House of Representatives]
...
```mermaid
graph TD
    A[A bill starts with an idea that people want to become a law] --> B[Congress writes a bill]
    B --> C[House of Representatives<br/>A majority of the 435 voting members approve]
    C --> D[Senate<br/>A majority of the 100 voting members approve]
    D --> E{Presidential Action}
    E --> F[The president signs the bill]
    E --> G[The president vetoes the bill]
    F --> H[The bill becomes a law]
    G --> I[The bill does NOT become a law]
```
...
graph LR
    ...
    B --> C[Speaker of the House]
    style A fill:#D9E2F3,stroke:#D9E2F3
    style B fill:#D9E2F3,stroke:#D9E2F3
    style C fill:#D9E2F3,stroke:#D9E2F3
```
